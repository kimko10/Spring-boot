...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
	...
	private ErrorHandle createErrorObject(Exception ex, HttpStatus status, WebRequest request) {
	...
	@ExceptionHandler({NullPointerException.class, BindException.class})
